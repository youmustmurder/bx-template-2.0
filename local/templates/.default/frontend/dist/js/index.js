...
function modalFromAjax(_ref) {
  var modalName = _ref.modalName,
      _ref$url = _ref.url,
      url = _ref$url === void 0 ? '/local/tools/ajax_form.php' : _ref$url,
      _ref$method = _ref.method,
      method = _ref$method === void 0 ? 'get' : _ref$method,
      _ref$dataAjax = _ref.dataAjax,
      dataAjax = _ref$dataAjax === void 0 ? {} : _ref$dataAjax,
      _ref$modalSettings = _ref.modalSettings,
      modalSettings = _ref$modalSettings === void 0 ? {} : _ref$modalSettings,
      before = _ref.before,
      after = _ref.after;
...
function () {
  ...
  _createClass(Tabs, [{
    ...
    value: function resetActive() {
      ...
      Array.prototype.forEach.call(this.toggles, function (toggle) {
        var activeToggle = _this3.el.querySelector('.tabs__toggle_active');
      ...
      Array.prototype.forEach.call(this.contents, function (content) {
        var activeContent = _this3.el.querySelector('.tabs__content_active');
