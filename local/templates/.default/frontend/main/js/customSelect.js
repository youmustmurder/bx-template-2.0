const customSelect = function(options, cbAfter, cbChoose) {
	...
	function onClickSelect(e) {
		...
		if (
			t.className === buttonClass + ' ' + buttonClass2 ||
			t.className === buttonValueClass
		) {
			toggle();
		}

		if (t.className === liClass) {
			selectContainer.querySelector('.' + buttonValueClass).innerText =
				t.innerText;
