	...
	<form class="settings-panel__inner tabs">
		<ul class="settings-panel__tabs-nav settings-panel-tabs-nav">
			...
			<li class="settings-panel-tabs-nav__item settings-panel-tabs-nav-item tabs__toggle">
				<button class="settings-panel-tabs-nav-item__btn" data-toggle="collapse" data-target="#home" aria-expanded="false" aria-controls="home">Главная</button>
			</li>
			<li class="settings-panel-tabs-nav__item settings-panel-tabs-nav-item tabs__toggle">
				<button class="settings-panel-tabs-nav-item__btn" data-toggle="collapse" data-target="#contact" aria-expanded="false" aria-controls="contact">Контакты</button>
			</li>
			<li class="settings-panel-tabs-nav__item settings-panel-tabs-nav-item tabs__toggle">
				<button class="settings-panel-tabs-nav-item__btn" data-toggle="collapse" data-target="#catalog" aria-expanded="false" aria-controls="catalog">Каталог</button>
			</li>
		</ul>
		<div class="settings-panel__tabs-content settings-panel-tabs-content">
			<div class="settings-panel-tabs-content__item settings-panel-tabs-content-item tabs__content tabs__content_active" id="common" aria-label="Общие настройки">
				<div class="settings-panel-tabs-content-item__header">Общие настройки</div>
