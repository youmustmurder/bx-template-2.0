                                        ...
                                        <?foreach ($parameters as $id => $parameter) {?>
                                            <div class="settings-option__card settings-option-card">
                                                ...
                                                <label for="setting_<?=$CODE?>_<?=$id?>" class="settings-option-card__inner">
                                                    <div class="settings-option-card__preview">
                                                        <img src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/news.list/home-slider_<?=$id?>/preview.png" alt="">
                                                    </div>
                                                    <div class="settings-option-card__name"><?=$parameter['NAME']?></div>
                                                </label>
                                            </div>
                                    ...
                                    <div class="settings-option__inner settings-option__inner_cards2">
                                        <?foreach ($parameters as $id => $parameter) {?>
                                            <div class="settings-option__card settings-option-card">
                                                ...
                                                <label for="setting_<?=$CODE?>_<?=$id?>" class="settings-option-card__inner">
                                                    <div class="settings-option-card__preview">
                                                        <img src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.section.list/home-section_<?=$id?>/preview.png" alt="">
                                                    </div>
                                                    <div class="settings-option-card__name"><?=$parameter['NAME']?></div>
                                                </label>
                                            </div>
                                    ...
                                    <div class="settings-option__inner settings-option__inner_cards2">
                                        <?foreach ($parameters as $id => $parameter) {?>
                                            <div class="settings-option__card settings-option-card">
                                                ...
                                                <label for="setting_<?=$CODE?>_<?=$id?>" class="settings-option-card__inner">
                                                    <div class="settings-option-card__preview">
                                                        <img src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.section/home-product_<?=$id?>/preview.png" alt="">
                                                    </div>
                                                    <div class="settings-option-card__name"><?=$parameter['NAME']?></div>
                                                </label>
                                            </div>
                                    ...
                                    <div class="settings-option__inner settings-option__inner_cards2">
                                        <?foreach ($parameters as $id => $parameter) {?>
                                            <div class="settings-option__card settings-option-card">
                                                ...
                                                <label for="setting_<?=$CODE?>_<?=$id?>" class="settings-option-card__inner">
                                                    <div class="settings-option-card__preview">
                                                        <img src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/news.list/home-service_<?=$id?>/preview.png" alt="">
                                                    </div>
                                                    <div class="settings-option-card__name"><?=$parameter['NAME']?></div>
                                                </label>
                                            </div>
                                    ...
                                    <div class="settings-option__inner settings-option__inner_cards2">
                                        <?foreach ($parameters as $id => $parameter) {?>
                                            <div class="settings-option__card settings-option-card">
                                                ...
                                                <label for="setting_<?=$CODE?>_<?=$id?>" class="settings-option-card__inner">
                                                    <div class="settings-option-card__preview">
                                                        <img src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/news.list/home-about_<?=$id?>/preview.png" alt="">
                                                    </div>
                                                    <div class="settings-option-card__name"><?=$parameter['NAME']?></div>
                                                </label>
                                            </div>
                                    ...
                                    <div class="settings-option__inner settings-option__inner_cards2">
                                        <?foreach ($parameters as $id => $parameter) {?>
                                            <div class="settings-option__card settings-option-card">
                                                ...
                                                <label for="setting_<?=$CODE?>_<?=$id?>" class="settings-option-card__inner">
                                                    <div class="settings-option-card__preview">
                                                        <img src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/news.list/home-news_<?=$id?>/preview.png" alt="">
                                                    </div>
                                                    <div class="settings-option-card__name"><?=$parameter['NAME']?></div>
                                                </label>
                                            </div>
