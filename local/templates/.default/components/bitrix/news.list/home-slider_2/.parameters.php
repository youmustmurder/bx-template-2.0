...
$arTemplateParameters = array(
    "SLIDER_AUTOPLAY" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_SLIDER_2_AUTOPLAY_TITLE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y'
    ),
    "SLIDER_ARROWS" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_SLIDER_2_ARROWS_TITLE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y'
    ),
    "SLIDER_TIME" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_SLIDER_2_AUTOPLAY_TIME_TITLE'),
        'TYPE' => 'STRING',
        'DEFAULT' => '3000'
    ),
    'NEWS_COUNT' => array(
        'NAME' => Loc::getMessage('HOME_SLIDER_2_NEWS_COUNT_TITLE'),
        'PARENT' => 'BASE',
        'TYPE' => 'STRING',
        'DEFAULT' => '5'
    ),
