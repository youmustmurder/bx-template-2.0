...
$arTemplateParameters = array(
    "BLOCK_TITLE" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_NEWS_1_BLOCK_TITLE_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_NEWS_1_BLOCK_TITLE_DEFAULT')
    ),
    "SECTION_LINK_NAME" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_NEWS_1_SECTION_LINK_NAME_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_NEWS_1_SECTION_LINK_NAME_DEFAULT')
    ),
    "SECTION_LINK" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_NEWS_1_SECTION_LINK_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_NEWS_1_SECTION_LINK_DEFAULT')
    ),
