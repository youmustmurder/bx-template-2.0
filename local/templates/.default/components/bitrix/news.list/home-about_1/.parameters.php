...
$arTemplateParameters = array(
    ...
    "SECTION_LINK_NAME" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_1_SECTION_LINK_NAME_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_ABOUT_1_SECTION_LINK_NAME_DEFAULT')
    ),
    "SECTION_LINK" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_1_SECTION_LINK_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_ABOUT_1_SECTION_LINK_DEFAULT')
    ),
    ...
    'NEWS_COUNT' => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_1_NEWS_COUNT_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => 3
    )
);