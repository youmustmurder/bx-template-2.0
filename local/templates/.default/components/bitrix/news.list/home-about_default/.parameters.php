...
$arTemplateParameters = array(
    "BLOCK_TITLE" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_DEFAULT_BLOCK_TITLE_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_ABOUT_DEFAULT_BLOCK_TITLE_DEFAULT')
    ),
    "SECTION_LINK_NAME" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_DEFAULT_SECTION_LINK_NAME_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_ABOUT_DEFAULT_SECTION_LINK_NAME_DEFAULT')
    ),
    "SECTION_LINK" => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_DEFAULT_SECTION_LINK_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('HOME_ABOUT_DEFAULT_SECTION_LINK_DEFAULT')
    ),
    ...
    /*'NEWS_COUNT' => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_DEFAULT_NEWS_COUNT_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => 3
    ),*/
    'BLOCK_IMG' => array(
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('HOME_ABOUT_DEFAULT_BLOCK_IMG_NAME'),
        'TYPE' => 'FILE',
        "FD_TARGET" => "F",
