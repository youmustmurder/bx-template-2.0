    ...
    ymaps.ready(function () {
      ...
      branches.forEach(function (branch, index) {
        ...
        Placemark[index] = new ymaps.Placemark([x, y], {
          ...
          iconImageHref: '/local/templates/.default/frontend/main/images/images/icon-geo.pn',
          iconImageSize: [60, 60],
          iconImageOffset: [-30, -30],
          iconLayout: 'default#imageWithContent',
          iconactive: '/local/templates/.default/frontend/main/images/images/icon-geo.png'
        });
