                    ...
                    <div class="slider-big-slide__wrap">
                        ...
                        <?if ($arItem['PROPERTIES']['LINK_SECTION']['VALUE']) {?>
                            <a href="<?=$arItem['PROPERTIES']['LINK_SECTION']['VALUE']?>"
                               class="btn <?=$arParams['SLIDER_BTN_TYPE'] == 'MID' ? 'btn_mid' : 'btn_big'?> btn_round btn_success-to-light"><?=$arItem['PROPERTIES']['LINK_BUTTON_NAME']['VALUE'] ?: Loc::getMessage('SLIDE_MORE')?></a>
                        <?}?>
                    </div>
					<img src="<?=GetNoPhoto()?>"
