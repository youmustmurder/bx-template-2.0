		...
		<div class="row">
			<div class="col">
				<div class="reviews__inner">
					...
					<a href="<?=$arParams['SECTION_LINK'] ?: Loc::getMessage('HOME_REVIEWS_1_SECTION_LINK_DEFAULT', array('#SITE_DIR#' => SITE_DIR))?>" class="btn__link btn__link--bold btn__link--green btn__link--icon-r reviews__link-all">
